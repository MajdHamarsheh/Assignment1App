...
public class PyramidAct extends AppCompatActivity {

     EditText editTextpy0;
     EditText editTextpy1;
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        editTextpy0 = findViewById(R.id.editTextpy0);
        editTextpy1= findViewById(R.id.editTextpy1);
        ...
        editTextpy0.setText(sharedPreferences.getString("editTextpy0Value", ""));
        editTextpy1.setText(sharedPreferences.getString("editTextpy1Value", ""));
        ...
        calculateButton.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                ...
                String str0 = editTextpy0.getText().toString();
                String str1 = editTextpy1.getText().toString();
    ...
    private void saveDataToSharedPreferences() {
        ...
        editor.putString("editTextpy0Value", editTextpy0.getText().toString());
        editor.putString("editTextpy1Value", editTextpy1.getText().toString());
        editor.apply();
    }
